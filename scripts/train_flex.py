...
Usage (from project root):
    python scripts/train_flex.py --label circle_only
    python scripts/train_flex.py --label square_only
    python scripts/train_flex.py --label cross_only
"""
...
from model.flexible_tnet import FlexibleTNet
from labels import attr_functions
